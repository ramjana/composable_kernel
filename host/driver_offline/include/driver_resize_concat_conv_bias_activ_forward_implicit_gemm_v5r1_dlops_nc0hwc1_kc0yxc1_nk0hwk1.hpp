...
void printTuningParameters()
{
    ...
    std::cout << "BlockSize_" << GridGemmTuningParameters_::BlockSize 
        << "_E1_" << GridGemmTuningParameters_::E1 
        << "_E2_" << GridGemmTuningParameters_::E2 
        << "_K2_" << GridGemmTuningParameters_::K2
        << "_KPerBlock_" << GridGemmTuningParameters_::KPerBlock 
        << "_HoPerBlock_" << GridGemmTuningParameters_::HoPerBlock 
        << "_WoPerBlock_" << GridGemmTuningParameters_::WoPerBlock 
        << "_E0PerBlock_" << GridGemmTuningParameters_::E0PerBlock 
        << "_E1PerBlock_" << GridGemmTuningParameters_::E1PerBlock
        << "_KPerThread_" << GridGemmTuningParameters_::KPerThread 
        << "_HoPerThread_" << GridGemmTuningParameters_::HoPerThread 
        << "_WoPerThread_" << GridGemmTuningParameters_::WoPerThread 
        << "_EPerThread_" << GridGemmTuningParameters_::EPerThread 
        << "_ABlockTransferThreadSliceLengths_<" << GridGemmTuningParameters_::ABlockTransferThreadSliceLengths_E0_E1_K0_K1_E2[I0]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadSliceLengths_E0_E1_K0_K1_E2[I1]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadSliceLengths_E0_E1_K0_K1_E2[I2]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadSliceLengths_E0_E1_K0_K1_E2[I3]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadSliceLengths_E0_E1_K0_K1_E2[I4]
        << ">"
        << "_ABlockTransferThreadClusterLengths_<" << GridGemmTuningParameters_::ABlockTransferThreadClusterLengths_E0_E1_K0_K1_E2[I0]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadClusterLengths_E0_E1_K0_K1_E2[I1]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadClusterLengths_E0_E1_K0_K1_E2[I2]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadClusterLengths_E0_E1_K0_K1_E2[I3]
        << "_" << GridGemmTuningParameters_::ABlockTransferThreadClusterLengths_E0_E1_K0_K1_E2[I4]
        << ">" << std::endl;
}
...
struct DriverDynamicResizeConcatConvBiasActivForwardImplicitGemmDlops_v5r1_nc0hwc1_kc0yxc1_nk0hwk1
{
                       ...
                       const int nrepeat) const
    {
        ...
        printTuningParameters<GridGemmTuningParameters1>();
        printTuningParameters<GridGemmTuningParameters2>();
        ...
        const auto N        = in1_n_c0_hi_wi_c1_global_desc.GetLength(I0);
        const auto CONV1_C0 = in1_n_c0_hi_wi_c1_global_desc.GetLength(I1);
        const auto Hi       = in1_n_c0_hi_wi_c1_global_desc.GetLength(I2);
        const auto Wi       = in1_n_c0_hi_wi_c1_global_desc.GetLength(I3);
        // const auto C1 = in_n_c0_hi_wi_c1_global_desc.GetLength(I4);

        const auto CONV2_C0 = in2_n_c0_hi_wi_c1_global_desc.GetLength(I1);
        ...
        const auto CONV1_E0 = (CONV1_C0 * Y * X) / E1;
        const auto CONV2_E0 = (CONV2_C0 * Y * X) / E1;

        // weight tensor
        const auto a1_e_k_e2_grid_desc = transform_tensor_descriptor(
            make_naive_tensor_descriptor_packed(make_tuple(K, CONV1_C0 * Y * X, E2)),
            make_tuple(make_pass_through_transform(K),
                       make_pass_through_transform(CONV1_C0 * Y * X),
                       make_pass_through_transform(E2)),
            make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}),
            make_tuple(Sequence<1>{}, Sequence<0>{}, Sequence<2>{}));

        const auto a1_e0_e1_k_e2_grid_desc =
            transform_tensor_descriptor(a1_e_k_e2_grid_desc,
                                        make_tuple(make_unmerge_transform(make_tuple(CONV1_E0, E1)),
