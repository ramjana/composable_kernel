...
op=group_conv_bias_activ_fwd_driver_offline_nchwc
...
echo "n: $n h: $h w: $w y: $y x: $x c0: $c0 c1: $c1 k0: $k0 k1: $k1 pad: {$p, $q} g: $g activ: $a"

echo "#define USE_CONV_FIG 1" >> $conv_fig

echo "#define CONV_G $g" >> $conv_fig
...
echo "#define CONV_K_PER_BLOCK K" >> $conv_fig
...
echo "#define CONV_K_PER_THREAD K" >> $conv_fig
echo "#define CONV_HO_PER_THREAD 1" >> $conv_fig
echo "#define CONV_WO_PER_THREAD 2" >> $conv_fig
echo "#define CONV_E_PER_THREAD 1" >> $conv_fig

echo "#define CONV_ABLOCK_TRANS_THREAD_SLICE_LENGTHS 1, 1, 1, 1, C1" >> $conv_fig
echo "#define CONV_ABLOCK_TRANS_THREAD_CLUSTER_LENGTHS 1, C0 * Y * X, 1, K0, 1" >> $conv_fig 
